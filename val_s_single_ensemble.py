...
class myEnsemble():
    ...
    def detect(self):
        ...
        for i in tqdm.tqdm(range(self.thr_iter)):
            thr = 0.02*i
            THRS = init_thr + thr
...
if __name__ == "__main__":
    ...
    # cfg_dict1 = {'exp': '1_V99_p2000_2',
    #             'ckpt':'model_0008252.pth',
    ...
    #             }
    # cfg_dict2 = {'exp': '1_R101_2',
    #             'ckpt':'model_0013099.pth',
    #             'config': model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_R_101_FPN_3x.yaml"),
    #             'opt':[1000,2000,2000,1],
    #             }
    # cfg_dict3 = {'exp': '1_R50CA_2',
    #             'ckpt':'model_0014147.pth',
    #             'config':model_zoo.get_config_file("Misc/cascade_mask_rcnn_R_50_FPN_3x.yaml"),
    #             'opt':[1000,2000,2000,1],
    #             }

    # cfg_dict4 = {'exp': '1_X101_2',
    #             'ckpt':'model_0013361.pth',
    #             'config':model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml"),
    #             'opt':[1000,2000,2000,1],
    #             }
    # cfg_dict5 = {'exp': '1_R101PR_2',
    #             'ckpt':'model_0014409.pth',
    #             'config': '/home/solomon/public/Pawn/detectron2-0.6/projects/PointRend/configs/InstanceSegmentation/pointrend_rcnn_R_101_FPN_3x_coco.yaml',
    #             'opt':[1000,2000,2000,1],
    #             }

    cfg_dict1 = {'exp': '2_V99_p2000_flipud_2',
                'ckpt':'model_0008452.pth',
                'config':'/home/solomon/public/Pawn/detectron2-0.6/projects/vovnet-detectron2-master/configs/mask_rcnn_V_99_FPN_3x.yaml',
                'opt':[1000,2000,2000,1],
                }
    cfg_dict2 = {'exp': '2_R101_2',
                'ckpt':'model_0014765.pth',
                'config': model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_R_101_FPN_3x.yaml"),
                'opt':[1000,2000,2000,1],
                }
    cfg_dict3 = {'exp': '2_R50CA_2',
                'ckpt':'model_0008773.pth',
                'config':model_zoo.get_config_file("Misc/cascade_mask_rcnn_R_50_FPN_3x.yaml"),
                'opt':[1000,2000,2000,1],
                }

    # cfg_dict1 = {'exp': '2_V99_p2000_2',
    #             'ckpt':'model_0013053.pth',
    #             'config':'/home/solomon/public/Pawn/detectron2-0.6/projects/vovnet-detectron2-master/configs/mask_rcnn_V_99_FPN_3x.yaml',
    #             'opt':[1000,2000,2000,1],
    #             }
    # cfg_dict2 = {'exp': '2_V99_p2000_flipud_2',
    #             'ckpt':'model_0008452.pth',
    #             'config':'/home/solomon/public/Pawn/detectron2-0.6/projects/vovnet-detectron2-master/configs/mask_rcnn_V_99_FPN_3x.yaml',
    #             'opt':[1000,2000,2000,1],
    #             }
    # cfg_dict3 = {'exp': '2_V99_p2000_2',
    #             'ckpt':'model_0006205.pth',
    #             'config':'/home/solomon/public/Pawn/detectron2-0.6/projects/vovnet-detectron2-master/configs/mask_rcnn_V_99_FPN_3x.yaml',
    #             'opt':[1000,2000,2000,1],
    #             }
    # cfg_dict4 = {'exp': '2_V99_p2000_flipud_2',
    #             'ckpt':'model_0008666.pth',
    #             'config':'/home/solomon/public/Pawn/detectron2-0.6/projects/vovnet-detectron2-master/configs/mask_rcnn_V_99_FPN_3x.yaml',
    #             'opt':[1000,2000,2000,1],
    #             }          

    # cfg_dict1 = {'exp': '3_V99_p2000',
    #             'ckpt':'model_0006439.pth',
    #             'config':'/home/solomon/public/Pawn/detectron2-0.6/projects/vovnet-detectron2-master/configs/mask_rcnn_V_99_FPN_3x.yaml',
    #             'opt':[1000,2000,2000,1],
    #             }
    # cfg_dict2 = {'exp': '3_V99_p2000_flipud',
    #             'ckpt':'model_0006439.pth',
    #             'config':'/home/solomon/public/Pawn/detectron2-0.6/projects/vovnet-detectron2-master/configs/mask_rcnn_V_99_FPN_3x.yaml',
    #             'opt':[1000,2000,2000,1],
    #             }
    # cfg_dict3 = {'exp': '3_V99_p2000',
    #             'ckpt':'model_0004479.pth',
    #             'config':'/home/solomon/public/Pawn/detectron2-0.6/projects/vovnet-detectron2-master/configs/mask_rcnn_V_99_FPN_3x.yaml',
    #             'opt':[1000,2000,2000,1],
    #             }
    # cfg_dict4 = {'exp': '3_V99_p2000_flipud',
    #             'ckpt':'model_0012319.pth',
    #             'config':'/home/solomon/public/Pawn/detectron2-0.6/projects/vovnet-detectron2-master/configs/mask_rcnn_V_99_FPN_3x.yaml',
    #             'opt':[1000,2000,2000,1],
    #             }            
    ...
    cfg_dicts = [cfg_dict1, cfg_dict2, cfg_dict3,
                 cfg_dict1, cfg_dict2, cfg_dict3,
                 cfg_dict1, cfg_dict2, cfg_dict3,
                 cfg_dict1, cfg_dict2, cfg_dict3,
                 cfg_dict1, cfg_dict2, cfg_dict3,
                 cfg_dict1, cfg_dict2, cfg_dict3,
    ...
    # output_dir = 'test_ensem1_mul'
    output_dir = 'test_ensem2_mul'
    # output_dir = 'test_ensem3'
    os.makedirs(output_dir, exist_ok=True)
    dataDir=Path('sartorius-cell-instance-segmentation/')

    # register_coco_instances('sartorius_val',{},f'val_shsy5y_1.json', dataDir)
    register_coco_instances('sartorius_val',{},f'val_astro_2.json', dataDir)
    # register_coco_instances('sartorius_val',{},f'val_cort_3.json', dataDir)
    cfgs, models=[], []
    for cfg_dict in cfg_dicts:
        cfg = get_cfg()
        if('V99' in cfg_dict['exp'] or 'VOV' in cfg_dict['ckpt']): add_vovnet_config(cfg)
        if('PR' in cfg_dict['exp']): 
            add_pointrend_config(cfg)
            cfg.MODEL.POINT_HEAD.NUM_CLASSES = cfg_dict['opt'][3]
        ...
        cfg.TEST.AUG.MIN_SIZES = (704, 800, 896, 992, 1088, 1184)
        # cfg.TEST.AUG.MIN_SIZES = (1184,)*len(cfg_dicts)
        cfg.TEST.AUG.MIN_SIZES = (1184,)*(len(cfg_dicts)//6) + (1088,)*(len(cfg_dicts)//6)+ (992,)*(len(cfg_dicts)//6) + \
             (896,)*(len(cfg_dicts)//6) + (800,)*(len(cfg_dicts)//6)+ (704,)*(len(cfg_dicts)//6)
            
        cfg.TEST.AUG.MAX_SIZE = 2000
        cfg.TEST.AUG.FLIP = False
        weight = os.path.join(cfg_dict['exp'], cfg_dict['ckpt'])
        model = myPredictor(cfg, weight)
        models.append(model.model)
        cfgs.append(cfg)

    from detectron2.modeling import GeneralizedRCNNWithEnsemble

    predictor = GeneralizedRCNNWithEnsemble(cfgs, models)
    ...
    MEnsem = myEnsemble(predictor, 'sartorius_val', 0)
    MEnsem.detect()